...
const UserForgotPassword = () => {
    const { backendUrl } = useContext(AppContext); // Use the same context or a user-specific context
    ...
    const handleForgotPassword = async (e) => {
        ...
        try {
            // Send email to the user forgot password endpoint
            const endpoint = `${backendUrl}/api/users/forgot-password`;
